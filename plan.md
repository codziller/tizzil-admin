...
1. When i push github and deploy to vercel, build fails with the error below. Please investigate and help fix it. Also tell me what went wrong and how you fixed it

[16:45:17.421] Running build in Washington, D.C., USA (East) – iad1
[16:45:17.422] Build machine configuration: 2 cores, 8 GB
[16:45:17.447] Cloning github.com/codziller/tizzil-admin (Branch: main, Commit: c5a0097)
[16:45:19.046] Cloning completed: 1.597s
[16:45:20.064] Restored build cache from previous deployment (HxbjYbXS65UBGadSDtMeKaKsFUUT)
[16:45:22.793] Running "vercel build"
[16:45:23.187] Vercel CLI 47.0.4
[16:45:23.967] Installing dependencies...
[16:45:24.395] yarn install v1.22.19
[16:45:24.502] warning package-lock.json found. Your project contains lock files generated by tools other than Yarn. It is advised not to mix package managers in order to avoid resolution inconsistencies caused by unsynchronized lock files. To clear this warning, remove package-lock.json.
[16:45:24.520] [1/4] Resolving packages...
[16:45:25.212] [2/4] Fetching packages...
[16:45:49.240] [3/4] Linking dependencies...
[16:45:49.242] warning " > @ckeditor/ckeditor5-react@6.2.0" has unmet peer dependency "@ckeditor/ckeditor5-core@>=40.1.0".
[16:45:49.243] warning " > @ckeditor/ckeditor5-react@6.2.0" has unmet peer dependency "@ckeditor/ckeditor5-editor-multi-root@>=40.1.0".
[16:45:49.243] warning " > @ckeditor/ckeditor5-react@6.2.0" has unmet peer dependency "@ckeditor/ckeditor5-engine@>=40.1.0".
[16:45:49.244] warning " > @ckeditor/ckeditor5-react@6.2.0" has unmet peer dependency "@ckeditor/ckeditor5-utils@>=40.1.0".
[16:45:49.244] warning " > @ckeditor/ckeditor5-react@6.2.0" has unmet peer dependency "@ckeditor/ckeditor5-watchdog@>=40.1.0".
[16:45:49.245] warning " > @mui/x-date-pickers@6.12.1" has unmet peer dependency "@mui/base@^5.0.0-alpha.87".
[16:45:49.246] warning " > @mui/x-date-pickers@6.12.1" has unmet peer dependency "@mui/system@^5.8.0".
[16:45:49.246] warning " > @testing-library/user-event@13.5.0" has unmet peer dependency "@testing-library/dom@>=7.21.4".
[16:45:49.247] warning " > draft-js-image-plugin@2.0.7" has incorrect peer dependency "react@^15.5.0 || ^16.0.0-rc".
[16:45:49.247] warning " > draft-js-image-plugin@2.0.7" has incorrect peer dependency "react-dom@^15.5.0 || ^16.0.0-rc".
[16:45:49.248] warning " > draft-js-plugins-editor@3.0.0" has incorrect peer dependency "react@^15.5.0 || ^16.0.0-rc".
[16:45:49.248] warning " > draft-js-plugins-editor@3.0.0" has incorrect peer dependency "react-dom@^15.5.0 || ^16.0.0-rc".
[16:45:49.250] warning " > react-draft-wysiwyg@1.15.0" has unmet peer dependency "immutable@3.x.x || 4.x.x".
[16:45:49.251] warning "react-draft-wysiwyg > draftjs-utils@0.10.2" has unmet peer dependency "immutable@3.x.x || 4.x.x".
[16:45:49.251] warning "react-draft-wysiwyg > html-to-draftjs@1.5.0" has unmet peer dependency "immutable@3.x.x || 4.x.x".
[16:45:49.255] warning "react-hot-toast > goober@2.1.13" has unmet peer dependency "csstype@^3.0.10".
[16:45:49.255] warning " > styled-components@5.3.11" has unmet peer dependency "react-is@>= 16.8.0".
[16:45:49.256] warning "react-loader-spinner > styled-components > babel-plugin-styled-components > @babel/plugin-syntax-jsx@7.22.5" has unmet peer dependency "@babel/core@^7.0.0-0".
[16:45:49.259] warning "react-scripts > eslint-config-react-app > eslint-plugin-flowtype@8.0.3" has unmet peer dependency "@babel/plugin-syntax-flow@^7.14.5".
[16:45:49.259] warning "react-scripts > eslint-config-react-app > eslint-plugin-flowtype@8.0.3" has unmet peer dependency "@babel/plugin-transform-react-jsx@^7.14.9".
[16:45:49.262] warning "@craco/craco > autoprefixer@10.4.15" has unmet peer dependency "postcss@^8.1.0".
[16:45:49.262] warning "react-scripts > react-dev-utils > fork-ts-checker-webpack-plugin@6.5.3" has unmet peer dependency "typescript@>= 2.7".
[16:45:49.267] warning "react-scripts > eslint-config-react-app > @typescript-eslint/eslint-plugin > tsutils@3.21.0" has unmet peer dependency "typescript@>=2.8.0 || >= 3.2.0-dev || >= 3.3.0-dev || >= 3.4.0-dev || >= 3.5.0-dev || >= 3.6.0-dev || >= 3.6.0-beta || >= 3.7.0-dev || >= 3.7.0-beta".
[16:45:49.269] warning " > react-sortablejs@6.0.0" has unmet peer dependency "@types/sortablejs@^1.10.0".
[16:45:49.272] warning " > react-sortablejs@6.0.0" has incorrect peer dependency "react@^16.9.0".
[16:45:49.273] warning " > react-sortablejs@6.0.0" has incorrect peer dependency "react-dom@^16.9.0".
[16:45:49.273] warning " > tsc-files@1.1.4" has unmet peer dependency "typescript@>=3".
[16:45:49.275] warning "@craco/craco > cosmiconfig-typescript-loader@1.0.9" has unmet peer dependency "@types/node@_".
[16:45:49.275] warning "@craco/craco > cosmiconfig-typescript-loader@1.0.9" has unmet peer dependency "typescript@>=3".
[16:45:49.276] warning "@craco/craco > cosmiconfig-typescript-loader > ts-node@10.9.2" has unmet peer dependency "@types/node@_".
[16:45:49.276] warning "@craco/craco > cosmiconfig-typescript-loader > ts-node@10.9.2" has unmet peer dependency "typescript@>=2.7".
[16:46:05.421] [4/4] Building fresh packages...
[16:46:06.676] success Saved lockfile.
[16:46:06.689] $ husky install
[16:46:06.827] husky - Git hooks installed
[16:46:06.831] Done in 42.44s.
[16:46:06.880] Running "yarn run build"
[16:46:07.091] yarn run v1.22.19
[16:46:07.123] $ node --max_old_space_size=12288 react-scripts build
[16:46:07.165] node:internal/modules/cjs/loader:1368
[16:46:07.165] throw err;
[16:46:07.166] ^
[16:46:07.166]
[16:46:07.166] Error: Cannot find module '/vercel/path0/react-scripts'
[16:46:07.166] at Function.\_resolveFilename (node:internal/modules/cjs/loader:1365:15)
[16:46:07.167] at defaultResolveImpl (node:internal/modules/cjs/loader:1021:19)
[16:46:07.167] at resolveForCJSWithHooks (node:internal/modules/cjs/loader:1026:22)
[16:46:07.167] at Function.\_load (node:internal/modules/cjs/loader:1175:37)
[16:46:07.167] at TracingChannel.traceSync (node:diagnostics_channel:322:14)
[16:46:07.167] at wrapModuleLoad (node:internal/modules/cjs/loader:235:24)
[16:46:07.168] at Function.executeUserEntryPoint [as runMain] (node:internal/modules/run_main:171:5)
[16:46:07.168] at node:internal/main/run_main_module:36:49 {
[16:46:07.168] code: 'MODULE_NOT_FOUND',
[16:46:07.168] requireStack: []
[16:46:07.169] }
[16:46:07.169]
[16:46:07.169] Node.js v22.18.0
[16:46:07.179] error Command failed with exit code 1.
[16:46:07.180] info Visit https://yarnpkg.com/en/docs/cli/run for documentation about this command.
[16:46:07.198] Error: Command "yarn run build" exited with 1
