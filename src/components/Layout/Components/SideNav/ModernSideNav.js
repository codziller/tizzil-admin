...
const ModernSideNav = ({ isCollapsed, toggleSidenav }) => {
  ...
  const brand = userData?.brand || JSON.parse(localStorage.getItem('brand') || '{}');
  ...
  if (isCollapsed) {
    return (
      <div className="w-16 h-full bg-[#444444] text-[#FBF0DC] flex flex-col items-center py-4">
        <button
  ...
  return (
    <div className="w-64 h-full bg-[#444444] text-[#FBF0DC] flex flex-col">
              ...
              {hasSubItems ? (
                ...
                >
                  <div className="flex items-center gap-3">
                    <Icon className={`w-[18px] h-[18px] ${isItemActive ? 'text-primary' : 'text-[#FBF0DC]'}`} />
