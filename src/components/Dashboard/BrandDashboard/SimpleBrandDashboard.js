      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="lg:col-span-2 space-y-5">
          ...
          <div className="bg-white rounded-lg border border-[#E5E7EB]">
            ...
            {/* Graph Content - Simple placeholder */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
            ...
            <div className="lg:col-span-2 bg-white rounded-lg border border-[#E5E7EB]">
              ...
              <div className="p-4 h-[200px] flex items-center">
                ...
                <div className="w-[150px] h-[150px] rounded-full bg-gradient-to-r from-blue-500 via-green-500 via-yellow-400 to-orange-500 mr-6 flex items-center justify-center">
...
SimpleBrandDashboard.propTypes = {
  userRole: PropTypes.string,
};

export default SimpleBrandDashboard;
