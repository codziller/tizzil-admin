...
const ProductCollectionsPage = ({
  ...
  const [activeProduct, setActiveProduct] = useState("All Collections");
  const [showNewCollectionModal, setShowNewCollectionModal] = useState(false);
  const [showProductDetailsModal, setShowProductDetailsModal] = useState(false);
  const [selectedProduct, setSelectedProduct] = useState(null);

  const productTabs = ["All Collections", "Featured", "New Collections"];
        ...
        <div className="flex flex-col justify-start items-start h-full w-full gap-y-5 mt-5">
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center h-64 w-full">
              ...
              <p className="text-[16px] text-[#777777] mb-8">collections</p>
              <Button
